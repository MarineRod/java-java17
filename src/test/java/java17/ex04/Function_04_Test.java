...
public class Function_04_Test {
    ...
    public void test_predicate_and() throws Exception {
     ...
     // Chainer les prédicats avec 'and'
        Predicate<Person> combinedPredicate = adult  //ces 3 lignes ont été rajoutées en plus
            .and(lastnameIsFrance)
            .and(firstnameIsArmor);
        
        //List<Person> result = null;
        List<Person> result = filter(personList, combinedPredicate);
